...
$expectedLines = array(
    'Frame including user file via require at ' . $runtimeRoot . '/complex_runtime_autoload.php:0',
    'Frame including user file via require at ' . $runtimeRoot . '/complex_runtime_config.php:0',
    'Frame including user file via require at ' . $runtimeRoot . '/complex_runtime_messages_en.php:0',
    'Frame including user file via require at ' . $runtimeRoot . '/complex_runtime_main.php:0',
    'Frame including user file via require_once at ' . $runtimeRoot . '/complex_runtime_lib.php:0',
...
$unexpectedLines = array(
    ...
    'No function id entry for "' . $runtimeRoot . '/complex_runtime_autoload.php:0',
    'No function id entry for "' . $runtimeRoot . '/complex_runtime_config.php:0',
    'No function id entry for "' . $runtimeRoot . '/complex_runtime_messages_en.php:0',
    'No function id entry for "' . $runtimeRoot . '/complex_runtime_main.php:0',
    'No function id entry for "' . $runtimeRoot . '/complex_runtime_lib.php:0',
